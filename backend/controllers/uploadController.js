...
async function processUpload(req, res) {
    try {
        ...
        const originalName = path.parse(req.file.filename).name; // "hello_world_{timestamp}"
        ...
        // Lưu file PDF vào thư mục output với format: translate_hello_world_{timestamp}.pdf
        const pdfFilename = `translated_${originalName}.pdf`;
